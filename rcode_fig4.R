#########################################
### This file can be used to obtain the raw AUC
### values showin in Figure 4 and Additional file 6.
#########################################
###  Parameters  ###
...
matome
out_f <- paste("Fig4_",PDEG, "_", sprintf("%3.2f", P1), "_", n1, "_fixed.txt", sep="")
